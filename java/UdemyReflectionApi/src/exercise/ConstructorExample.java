...
public class ConstructorExample {
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		Address address = createInstancesWithArguments(Address.class, "kareemganj",434);
		Person person = createInstancesWithArguments(Person.class,"Jhon",20,address);
		
		System.out.println(person);
	}
	
	public static <T> T createInstancesWithArguments(Class<T> clazz,Object ... args) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
